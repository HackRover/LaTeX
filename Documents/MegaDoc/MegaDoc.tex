...
-----------------------------
DANNY. REVIEW THIS SECTION FOR MODIFICATIONS/DISCUSS ABOUT LAUNCH FILE.	
-----------------------------
...
-----------------------------
DANNY. REVIEW THIS SECTION.	I BS'D IT, BUT YOU NEED TO MAKE IT NICER, MAYBE ADD IMAGES.
-----------------------------
...
-----------------------------
DANNY. REVIEW THIS SECTION.	Again I tried to BS it at the last moment. Based on what you talked about in the GUI or Interface advance in best practices.
-----------------------------
...
-----------------------------
DANNY. REVIEW THIS SECTION.	Since you designed the controls you need to discuss usability. Not what did you, but what SHOULD you do. Don't forget, this is section B, they assume we write it well before we make the  rover.
-----------------------------
...
-----------------------------
DANNY. REVIEW THIS SECTION.	I looked at your tier 2 schematics, and they're actually tier 1. Move them here and make some new Tier 3's if you can.
-----------------------------
...
\pagebreak
		...
		Figure \ref{dominant_nodes} details the interaction between the Intel RealSense LIDAR L515 with the NVIDIA Xavier. The ROS node that is used as the publisher of the LIDAR image data to then be sent to a subscriber to the image data uses image\_ transport as the library to export the images from the LIDAR to the processing node in a low-bandwidth compressed format to reduce latency. The image processing node has computer vision models within the node to process the image using OpenCV, which is then sent to the Xavier as data that the Xavier will use for further motion logic or displaying the image to the user.
...
-----------------------------
DANNY. REVIEW THIS SECTION. Add tier three schematics please. Every single software node you made, the linker file you edited, the launch scripts you wrote, etc, should be in a Tier 3 schematic.	
-----------------------------
-----------------------------
...
-----------------------------
DANNY. REVIEW THIS SECTION.	It looks like it  was copy-pasted from some old version of the MegaDoc. It's not realistic nor a reflection of what we did. We didn't use a RBPi or Xavier. Ignore the broken image placement for now, btw, I'll fix it later.
-----------------------------
...
\section{Methodology}
-----------------------------
DANNY. REVIEW THIS SECTION.	Add a section for software. You've got to discuss software validation, tests that you did, methods that you used. You can talk about how you created launch scripts, or the  way you know the rover is working, etc.
-----------------------------
...
-----------------------------
DANNY. Add your content for results and discussion too.
-----------------------------
...
-----------------------------
DANNY. Add content about basic bootup, login, connecting to the internet, how to setup controls, etc. INCLUDE IMAGES. Point and click adventure type stuff.
Please also talk about the filesystem for our rover, and detail the nodes, what each node does, etc.
-----------------------------
