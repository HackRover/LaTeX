...
\subsection{Software User Manual:}
	...
	\begin{figure} [!h]
		\centering
		\includegraphics[scale=0.6]{Photos/Start ROSCORE.png}
	...
	\begin{figure} [!h]
		\centering
		\includegraphics[scale=0.6]{Photos/Start SLAM.png}
	...
	\begin{figure} [!h]
		\centering
		\includegraphics[scale=0.6]{Photos/Start Rviz.png}
	...
	\begin{figure} [!h]
		\centering
		\includegraphics[scale=0.6]{Photos/Modify Launch.png}
